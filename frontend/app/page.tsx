    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px', backgroundColor: '#D4D0C8', maxWidth: '640px' }}>
        {[
          ...
          { codigo: '04', titulo: 'Pedidos', desc: 'criação e gestão de pedidos', href: '/pedidos', status: 'ativo' },
          { codigo: '05', titulo: 'Visualização', desc: 'gráficos e analytics de vendas', href: '/visualizacao', status: 'ativo' },
          { codigo: '06', titulo: 'Decisão', desc: 'random forest — churn e propensão', href: '/decisao', status: 'ativo' },
          { codigo: '07', titulo: 'Relatórios', desc: 'listagens e análises gerenciais', href: '/relatorios', status: 'ativo' },
        ].map((mod) => (
